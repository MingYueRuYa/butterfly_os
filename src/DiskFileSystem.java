public class DiskFileSystem {
    ...
    public void flashFileHeaders() {
        floppyWriter.writeFloppy(Floppy.MAGNETIC_HEAD.MAGNETIC_HEAD_0, 
                                    cylinder, beginSec, buffer);
    }
    ...
    private void flashFileContent(FileHeader header) {
        ...
        short sectors = 
                (short)(header.getFileSize() / SECTOR_SIZE + 1);
        byte[] s = new byte[2];
        ...
        while (sectors > 0) {
            ...
            pos += 512;
            if (header.getFileBuffer() != null) {
                floppyWriter.writeFloppy(
                        Floppy.MAGNETIC_HEAD.MAGNETIC_HEAD_0,
                        fileContentCylinder, fileContentSector,
                        buf);
            }
